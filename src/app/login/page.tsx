          ...
          <Card className="w-full glass-card rounded-2xl border-0 overflow-hidden shadow-none">
            <CardHeader className="text-center pb-4">
              <div className="text-center mb-6">
                ...
                <h1 className="text-2xl font-bold brand-gradient">Sign in to your account</h1>
              </div>
            </CardHeader>
            ...
            <CardFooter className="px-6 pt-2 pb-6">
              <div className="mt-6 text-center text-sm text-gray-700">
                ...
                <Link href="/signup" className="text-indigo-700 hover:text-indigo-900 font-medium hover:underline transition-colors">
                  Sign up
                </Link>
              </div>
            </CardFooter>
